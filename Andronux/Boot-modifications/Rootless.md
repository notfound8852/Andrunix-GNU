...
**[initial_setup](https://github.com/notfound8852/Andronux-GNU/Andronux/scripts/initial_script.sh)**
...
```
if you are unsure, refer to [this](https://github.com/notfound8852/Andronux-GNU/Andronux/Boot-modifications/examples.md)
...
cat bootimg.cfg
```
and accordingly pack up your image using mkbootimg.. check examples.md for a quick tutorial on what to do. [here](https://github.com/notfound8852/Andronux-GNU/Andronux/Boot-modifications/examples.md)
