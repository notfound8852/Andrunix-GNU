...
5. Now you need to install sshd in the rootfs for that run [this](https://github.com/notfound8852/Andronux-GNU/Andronux/scripts/setup_linux.sh) script as root and export path.
```sh
chmod +x setup_linux
./setup_linux
